...
require (
	...
	github.com/aws/aws-cdk-go/awscdklambdagoalpha/v2 v2.153.0-alpha.0
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodbstreams/attributevalue v1.13.71 // indirect
